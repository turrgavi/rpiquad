...
class motor(object):
    ...
    def increaseW3(self, step=1):
        "increases W% for the motor"

        self.__W = self.__W + step*2
        self.setW(self.__W)

    def increaseW2(self, step=1):
        "increases W% for the motor"

        self.__W = self.__W + step*3
        self.setW(self.__W)
    ...
    def decreaseW3(self, step=1):
        "decreases W% for the motor"

        self.__W = self.__W - step*2
        self.setW(self.__W)

    def decreaseW2(self, step=1):
        "decreases W% for the motor"
